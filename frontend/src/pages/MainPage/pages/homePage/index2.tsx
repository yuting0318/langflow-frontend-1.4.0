...
import HeaderComponent2 from "../../components/header/index2";
...
const HomePage2 = ({ type }: { type: "flows" | "components" | "mcp" }) => {
    ...
    >
      ...
      >
        <div className="flex h-full w-full flex-col xl:container">
          ...
          />
          <div className="flex flex-1 flex-col justify-start px-2.5 ">
